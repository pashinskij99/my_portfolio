...
export const ButtonContact = ({children, onClick, className}) => {
  ...
  return (
    <button onMouseEnter={() => dispatch(changeCursor('onEnter'))}
            onMouseLeave={() => dispatch(changeCursor('default'))} onClick={onClick}
            className={clsx(styles.btnContact, ...className)}>
...
export const ButtonResume = ({children, onClick}) => {
  ...
  return (
    <button onMouseEnter={() => dispatch(changeCursor('onEnter'))}
            onMouseLeave={() => dispatch(changeCursor('default'))} onClick={onClick} className={styles.btnResume}>
      <span>{children}</span>
    </button>
  )
}
...
export const ButtonMore = ({children, onClick, className}) => {
  ...
  return (
    <button onMouseEnter={() => dispatch(changeCursor('onEnter'))}
            onMouseLeave={() => dispatch(changeCursor('default'))} onClick={onClick}
            className={clsx(styles.btnMore, ...className)}>
      {children}
    </button>
  )
}
